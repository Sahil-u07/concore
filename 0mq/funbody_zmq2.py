...
# ZMQ settings
ZMQ_PORT_NAME = "FUNBODY_REP_PORT" 
ZMQ_BIND_ADDRESS = "tcp://*:2355"  
...
while concore2.simtime < concore.maxtime:
    received_u_data = concore.read(ZMQ_PORT_NAME, "u_signal", init_simtime_u_str)
    ...
    concore.write(ZMQ_PORT_NAME, "ym_signal", ym_full_to_send)
